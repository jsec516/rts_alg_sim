...
function lst() {
	...
	for (var i = 0; i < task_info_lst.length; i++) {

		var task_id = task_info_lst[i][0];
		var period = task_info_lst[i][1];
		var wcet = task_info_lst[i][2];
		var a_time = 0.0
	...
	*/
	...
	var total_tasks = task_info_lst.length;
	var last_process = 0;
...
function lstinsert(a, b, c) {
	task_info_lst.push([a, b, c]);
}
